...
- **Next**: Vertex AI, semantic cache plugin, or other Bifrost-roadmap providers (GitHub Copilot #23 and dynamic injection-guard signatures parked in `design/backlog.md`)
